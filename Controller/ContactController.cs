...
namespace btlast.Controller
{
    ...
    {
        public string From { get; set; } = "milyonlarcaharf@gmail.com";
        public string Host { get; set; } = "smtp.gmail.com";
        public int Port { get; set; } = 587;
        public string Username { get; set; } = "milyonlarcaharf@gmail.com";
        public string Password { get; set; } = "dpod wxlp xrbu ogbg";
    ...
    public class ContactController : SurfaceController
    {
        ...
        public async Task<IActionResult> SubmitContactForm(ContactFormViewModel model)
        {
            ...
            try
            {
                ...
                email.To.Add(new MailboxAddress(_smtpSettings.From, _smtpSettings.From));
